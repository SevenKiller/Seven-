...
- (void)layoutSubviews {
    ...
    //头像
    NSString *userStr = _commentModel.user.profile_image_url;
    [imageView sd_setImageWithURL:[NSURL URLWithString:userStr]];
    ...
    _commentTextLabel.frame = CGRectMake(imageView.right+10, nameLabel.bottom+5, kScreenWidth-70, height);
